      ...
      <div className="relative px-8">
        ...
        >
          {carouselItems.map((item, index) => (
            <div
              key={index}
              className="flex-none w-96 snap-center bg-[#F6F6F6] text-[#161D6F] rounded-lg shadow-md overflow-hidden"
            >
              <img
                src={item.image}
                alt={item.title}
              ...
              <div className="p-6 space-y-3">
                ...
                <Link href={item.link}>
                  <button className="px-4 py-2 bg-[#98DED9] text-[#161D6F] rounded-lg hover:bg-blue-400 transition-colors duration-200">
                    Learn More
                  </button>
                </Link>
              </div>
