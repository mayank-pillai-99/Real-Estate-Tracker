...
export default function Footer() {
  return (
    <footer className="w-full bg-[#161D6F] text-[#F6F6F6] py-8">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/properties" className="hover:text-blue-400 transition-colors duration-200">
                Properties
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li  className="hover:text-blue-400 transition-colors duration-200">Phone:+91 999999999</li>
            <li>Email: <a href="mailto:support@realytics.com" className="hover:text-blue-400 transition-colors duration-200">support@realytics.com</a></li>
            <li>
