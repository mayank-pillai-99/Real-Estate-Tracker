              ...
              <div className="mb-10">
                  ...
                  <div className="bg-[#F9FAFB] text-[#333333] rounded-lg shadow-md p-6">
                      <div className="flex flex-wrap gap-6 mb-4">
                          <div>
                              <p className="font-medium text-base">{property.bedrooms} Bed</p>
                              <p className="text-sm text-[#333333]/80">Bedrooms</p>
                          </div>
                          <div>
                              <p className="font-medium text-base">{property.bathrooms} Bath</p>
                              <p className="text-sm text-[#333333]/80">Bathrooms</p>
                          </div>
                          <div>
                              <p className="font-medium text-base">{property.yearBuilt}</p>
                              <p className="text-sm text-[#333333]/80">Year Built</p>
                          </div>
                          <div>
                              <p className="font-medium text-base">{property.propertyType}</p>
                              <p className="text-sm text-[#333333]/80">Property Type</p>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {property.resoFacts.map((fact, index) => (
                          <div key={index} className="bg-[#F9FAFB] text-[#333333] rounded-lg shadow-md p-6">
                              <p className="font-medium text-base">{fact.factValue}</p>
                              <p className="text-sm text-[#333333]/80">{fact.factLabel}</p>
                          </div>
                      ))}
                  </div>
              </div>
              ...
              <div className="mb-10">
                  ...
                  <div className="space-y-6">
                      {property.schools.map((school, index) => (
                          <div key={index} className="bg-[#F9FAFB] text-[#333333] rounded-lg shadow-md p-6">
                              <a href={school.link} target="_blank" rel="noopener noreferrer" className="text-[#D4A017] hover:underline text-lg font-medium">
                                  {school.name}
                              </a>
