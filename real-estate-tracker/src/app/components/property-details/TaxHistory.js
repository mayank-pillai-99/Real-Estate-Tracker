...
const TaxHistoryGraph = () => {
    ...
    // Filter out entries with null taxPaid and sort by date (oldest to newest)
    ...
    return (
        <section className="py-12 bg-[#1A3C5A] text-[#F9FAFB]">
            <div className="max-w-7xl mx-auto px-4">
                <h2 className="text-2xl font-bold text-[#F9FAFB] mb-6">Tax History Graph</h2>
                <div className="bg-[#F9FAFB] rounded-lg shadow-md p-6 mb-6">
                    <Line data={chartData} options={options} />
                </div>
                <div className="bg-[#F9FAFB] rounded-lg shadow-md p-6 text-[#333333]">
                    <h3 className="text-xl font-bold text-[#D4A017] mb-4">Tax History Analytics</h3>
